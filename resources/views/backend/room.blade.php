                ...
                <div class="row">
                    <div class="col owl-carousel owl-theme week_carousel">
                        ...
                        <div class="card mb-4 list-weeks active">
                            <div class="card-body p-0">
                                <span class="text-uppercase">
                                    <a class="nav-link edit-pretest" href="#" data-toggle="modal" data-target="#Pretest">
                                        {{-- <i class="far fa-calendar-alt fa-lg"></i> --}}
                        ...
                        <div class="card mb-4 list-weeks active">
                            <div class="card-body p-0">
                                <span class="text-uppercase">
                                    <a class="nav-link edit-pretest" href="#" data-toggle="modal" data-target="#Export">
                                        {{-- <i class="far fa-calendar-alt fa-lg"></i> --}}
                    ...
                    @foreach ($post as $posts)
                        <div class="col-xl-10 mx-auto">
                            <div class="text-right">
                                <p class="created">{{$posts->created_at}}</p>
                            </div>
                            <div class="card mb-4 border-0 shadow-theme card-room card-radius">
                                <div class="card-header clearfix bg-blue">
                                    ...
                                    <div class="float-right">
                                        <small class="text-white pr-2 d-inline updated">{{$posts->updated_at}}</small>
                                        <div class="dropdown d-inline dropdown_post">
                                            ...
                                            <a href="#" class="link_icon" id="dropdownPost" data-toggle="dropdown"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right animate slideIn border-0 shadow"
                                                    ...
                                                    <a href="#" class="dropdown-item edit-modal"
                                ...
                                <div class="row">
                                        ...
                                        <a href="{{route('content.show', ['id' => $posts->con_id])}}">
                                            <div class="card-body mt-3">
                                                <div id="item{{$posts->con_id}}">
                                                        ...
                                                        @if($posts->con_file)
                                                            <a href="{{asset('storage')}}/{{$posts->con_file}}" class="text-primary"><i class="far fa-file-archive"></i> Download</a>
                                                        @endif
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="col-4 mx-auto align-self-center">
                                        <a href="{{route('content.show', ['id' => $posts->con_id])}}"><h1 class="text-decoration-none mr-5 text-primary text-right">{{$posts->comment}} <i class="far fa-comments"></i></h1></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-xl-3 d-none d-lg-block">
                <div class="card border-0 shadow-theme mb-4">
                    ...
                    <div class="card-body mx-auto">
                        ...
                        @if($pretest_num != 0)
                            <input type="range" id="slider" min="0" max="100" value="{{(($fillvalue * 100) / $pretest_num)}}">
                        @else
                            <input type="range" id="slider" min="0" max="100" value="{{0}}">
                        @endif

                        <!-- <input type="range" id="slider" min="0" max="100" value="100"> -->
                        <!-- {{-- <input type="range" id="slider" min="0" max="100" value="{{$fillvalue}}"> --}} -->
                    </div>
...
@section('modal')
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleDelteamLabel">...</h5>
                        ...
                        @csrf
                            ...
                            <div class="modal-footer">
                                        <button type="submit" class="btn actionBtn" >
                                            <span id="footer_action_button" class='glyphicon editContent'></span>
                                        </button>
            ...
            <div class="modal-content">
                ...
                <div>
                        <input type="hidden" class="form-control" name="userid" id="userid" aria-describedby="helpId" placeholder="">
                         <input type="hidden" class="form-control" name="clsid" id="clsid" aria-describedby="helpId" value="{{$id->cls_id}}">
                    </div>
    ...
    <div class="modal fade" id="Setting" tabindex="-1" role="dialog" aria-labelledby="Setting"
                        ...
                        <div class="form-row form-group">
                            ...
                            <div class="col-4">
                                <select class="form-control" name="cls_term" required>
                                    ...
                                    @if($id->cls_term)
                                        <option value="{{$id->cls_term}}" selected>ภาคเรียน {{$id->cls_term}}</option>
                                    @else
        ...
        <!------------------------- Modal Pretest Classroom ------------------------->
        <div class="modal fade" id="Pretest" tabindex="-1" role="dialog" aria-labelledby="Pretest"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                {{-- <form action="" method="post" enctype="multipart/form-data" role="form"> --}}
                <form action="{{route('pretest.import', ['id' => $id->cls_id])}}" method="post" enctype="multipart/form-data" role="form">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="Setting">Examination Classroom</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true"><i class="fas fa-times"></i></span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-row form-group">
                            <div class="col-12">
                            <input type="text" class="form-control" placeholder="ชื่อชุดข้อสอบ" name="cls_name" required>
                            </div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-12">
                                ...
                                {{-- accept=".csv" --}}
                                <label class="custom-file-label" for="file">Upload Examination (.xlsx)</label>
                            </div>
                        </div>


                        <a href="{{asset('excel/Simple_Exam.xlsx')}}"><i class="far fa-file-archive"></i> Download Template</a>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-outline-theme">Upload</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <!------------------------- Modal Export Classroom ------------------------->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{route('pretest.export', ['id' => $id->cls_id])}}" method="post" enctype="multipart/form-data" role="form">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="Export">Examination Export</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true"><i class="fas fa-times"></i></span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Examination Select</label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-outline-theme">Export</button>
                    </div>
                </form>
            </div>
        </div>
